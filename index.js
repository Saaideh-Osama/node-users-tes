...
var app=express();
var localStorage = loca
const {MongoClient}=require('mongodb')

var connection="mongodb+srv://saaidehosama:F9mpzQNZq837fXxD@inventory.eklpag8.mongodb.net/?retryWrites=true&w=majority&appName=inventory"
...
app.post("/login",urlEncoded, async(req,res)=>
{
      ...
      if (finduser) 
      {
        var userinformation = localStorage.setItem({user:finduser} )
...
{     
    ...
    const createuser= await collection.insertOne({'username': req.body.username,'email': req.body.email,'password': req.body.password,
